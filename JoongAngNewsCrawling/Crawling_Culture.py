...
db       = Db()
main_url = [
    'https://news.joins.com/culture/book/list/', 'https://news.joins.com/culture/performance/list/',
    'https://news.joins.com/culture/song/list/', 'https://news.joins.com/culture/movie/list/'
]
