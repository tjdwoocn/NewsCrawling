...
db       = Db()
main_url = [
    'https://news.joins.com/money/finance/list/', 'https://news.joins.com/money/stock/list/',
    'https://realestate.joins.com/article/?page=', 'https://news.joins.com/money/itview/list/'
]
