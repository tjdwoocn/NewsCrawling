...
db       = Db()
main_url = [
    'https://news.joins.com/politics/bluehouse/list/', 'https://news.joins.com/politics/assemgov/list/',
    'https://news.joins.com/politics/diplomacy/list/', 'https://news.joins.com/politics/nk/list/'
]
