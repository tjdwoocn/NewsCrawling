...
db       = Db()
main_url = [
    'https://news.joins.com/society/environment/list/', 'https://news.joins.com/society/education/list/',
    'https://news.joins.com/society/accident/list/', 'https://news.joins.com/society/welfare/list/'
]
